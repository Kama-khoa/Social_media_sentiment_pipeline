...
| `layer_0_config/init_config_tables.py` | Tạo 13 bảng config, catalog và tracking: channel/keyword, product catalog, moderation, overrides, crawl state và quota |
...
| `layer_3_intermediate/init_intermediate_tables.py` | Tạo 6 bảng trung gian: sentence, NLP result và product target resolution |
...
| `migrate_product_catalog.py` | Nâng cấp môi trường hiện có: tạo bảng catalog, nạp `seed_products.csv` và template specs |
...
run_all.py
    ...
    │       product_config, product_aliases, product_details
    │       product_spec_templates, product_detail_change_requests
    │       product_resolution_candidates
    │       video_product_overrides, sentence_product_target_overrides
    │       video_crawl_state
